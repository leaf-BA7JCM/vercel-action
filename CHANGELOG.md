...
## [43.0.0](https://github.com/leaf-BA7JCM/vercel-action/compare/v42.3.0...v43.0.0) (2026-04-30)
...
* add vercel-build action input for local Vercel build step ([#361](https://github.com/leaf-BA7JCM/vercel-action/issues/361)) ([4076535](https://github.com/leaf-BA7JCM/vercel-action/commit/4076535003c4a1d99063382298f4be63c7d64817))
...
* **comment:** redesign deployment comments with rich HTML table ([#320](https://github.com/leaf-BA7JCM/vercel-action/issues/320)) ([255bd7b](https://github.com/leaf-BA7JCM/vercel-action/commit/255bd7ba961b97c03107fb43b8d2d1ad05e40069))
...
* **example:** add turbopack configuration to nextjs example ([#315](https://github.com/leaf-BA7JCM/vercel-action/issues/315)) ([aae0c95](https://github.com/leaf-BA7JCM/vercel-action/commit/aae0c954252f21c9af8e0c99396c778d4f847027))
...
* GitHub Deployment integration ([#322](https://github.com/leaf-BA7JCM/vercel-action/issues/322)) ([3c572bd](https://github.com/leaf-BA7JCM/vercel-action/commit/3c572bd13515d06e00ca6581eb83a54be340e072))
...
* make CLI deployment default, gate API behind experimental-api flag ([#363](https://github.com/leaf-BA7JCM/vercel-action/issues/363)) ([2c02881](https://github.com/leaf-BA7JCM/vercel-action/commit/2c028814998cd1765cb788e1fe3fd2739470590e))
...
* auto-retry deployment when personal account org ID causes scope error ([#298](https://github.com/leaf-BA7JCM/vercel-action/issues/298)) ([1b0001f](https://github.com/leaf-BA7JCM/vercel-action/commit/1b0001faddbd6f631a9ae467c70e3d36e8ebecc4))
...
* clear VERCEL_ORG_ID and VERCEL_PROJECT_ID env vars on alias retry ([#312](https://github.com/leaf-BA7JCM/vercel-action/issues/312)) ([e34aeb6](https://github.com/leaf-BA7JCM/vercel-action/commit/e34aeb675588e9812975529addb3971bc7f4d3f7))
...
* **example:** move express-basic-auth function to api/ directory ([#308](https://github.com/leaf-BA7JCM/vercel-action/issues/308)) ([1c7fbdd](https://github.com/leaf-BA7JCM/vercel-action/commit/1c7fbdd4551c032cc7186140489c18dc94530a2d))
* **example:** update nextjs example dependencies to latest versions ([#313](https://github.com/leaf-BA7JCM/vercel-action/issues/313)) ([1043003](https://github.com/leaf-BA7JCM/vercel-action/commit/1043003e7fb6be077b6a3f95870df6a0b6121b94))
...
* forward vercel-project-id to API deployment body for prebuilt deployments ([#331](https://github.com/leaf-BA7JCM/vercel-action/issues/331)) ([1d5e098](https://github.com/leaf-BA7JCM/vercel-action/commit/1d5e098a150a39d3b9e04fbb8c42bcccf8f47c1c))
...
* require both vercel-org-id and vercel-project-id for deployment ([#304](https://github.com/leaf-BA7JCM/vercel-action/issues/304)) ([c5205ad](https://github.com/leaf-BA7JCM/vercel-action/commit/c5205ad240304b884ff8d3084aa791d3bcc93dd5))
* resolve vercel CLI v41 scope error for personal accounts ([#297](https://github.com/leaf-BA7JCM/vercel-action/issues/297)) ([b591ac8](https://github.com/leaf-BA7JCM/vercel-action/commit/b591ac88b0a8142d0289a6e6cc52cad6d6b569c6))
* restore relative working-directory support in API deployment ([#341](https://github.com/leaf-BA7JCM/vercel-action/issues/341)) ([#349](https://github.com/leaf-BA7JCM/vercel-action/issues/349)) ([a402367](https://github.com/leaf-BA7JCM/vercel-action/commit/a402367d0ef8a075898aafed4db12964b6fb33ae))
* retry alias command without --scope for personal accounts ([#310](https://github.com/leaf-BA7JCM/vercel-action/issues/310)) ([b1a533d](https://github.com/leaf-BA7JCM/vercel-action/commit/b1a533db34e3a4f0b79082d9037f49d2da0a8c45))
...
* **vercel-api:** normalize engines.node and drop nowConfig payload field ([#364](https://github.com/leaf-BA7JCM/vercel-action/issues/364)) ([31671aa](https://github.com/leaf-BA7JCM/vercel-action/commit/31671aa78ffb41ccf2f41f25010d44d77ae67721))
* **vercel-api:** send nowConfig and projectSettings to honor vercel.json ([#350](https://github.com/leaf-BA7JCM/vercel-action/issues/350)) ([ed665b2](https://github.com/leaf-BA7JCM/vercel-action/commit/ed665b2a904177e8e178eb5709bf3b9c0d474c92))
...
* migrate to TypeScript with Vitest and modern tooling ([#311](https://github.com/leaf-BA7JCM/vercel-action/issues/311)) ([feb50fe](https://github.com/leaf-BA7JCM/vercel-action/commit/feb50fe48df2033d3ca44a75722c1294487d2f78))
